...
# LQ 1
How many total TFs did you find in your protein sequence file? 
...
Cop this file into your directory. It is found in the folder: ```/projects/class/binf3101_001/tf_files/``` 
...
To extract the sequence we want we need to save the information to a file. Make sure to replace SEQUENCE_NAME with your sequence name and the start/end positions. 
